export default class QrScanner {
    ...
    _updateSourceRect() {
		...
		if(this.$video.videoWidth < this.$video.videoHeight) {
			...
			this.$video.style.top = ((((this.$video.videoHeight - this.$video.videoWidth) / this.$video.videoWidth) / 2) * (-100)) + '%';
			this.$video.style.width = '100%';
			this.$video.style.height = 'auto';
		} else {
			this.$video.style.left = ((((this.$video.videoWidth - this.$video.videoHeight) / this.$video.videoHeight) / 2) * (-100)) + '%';
